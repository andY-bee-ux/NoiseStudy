...
Les données collectées feront l'objet d'une analyse statistique en deux temps. 
Dans un premier temps, une analyse de variance (ANOVA) permettra de comparer 
