...
Les données collectées feront l'objet d'une analyse statistique, basée sur l'algorithme des composantes principales (ACP) afin de vérifier la cohérence des résultats avec le modèle circomplexe d'Axelsson et al. (2010). Des tests d'hypothèse seront également réalisés afin de comparer les scores perceptifs avant et après superposition, afin d'identifier les combinaisons les plus efficaces et d'établir le système de correspondance.
