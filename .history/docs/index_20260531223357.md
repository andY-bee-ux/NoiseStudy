...
C# PROPOSITION ET OBJECTIFS

Ce projet propose une démarche en deux phases complémentaires, réalisées au 
cours d'une seule et même expérience, articulées autour de la **perception 
...
- Constituer un corpus de sons résidentiels urbains normalisé et représentatif 
  du contexte montréalais;
- Établir une taxonomie perceptive des sons à partir des évaluations de 
  participants;
- Identifier les combinaisons son naturel / son isolé les plus efficaces pour 
  améliorer la perception globale;
- Produire un système de correspondance exploitable dans une perspective de 
  design sonore résidentiel;
- Développer un prototype de dispositif adaptatif capable de détecter 
  automatiquement un son ambiant et de déclencher la lecture du son 
