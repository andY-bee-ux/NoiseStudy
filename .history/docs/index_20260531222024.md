...
## Phase 2 : Requalification sonore 
 ...
 Des mixages sont générés en superposant les différents extraits sonores avec des sons naturels, selon différents ratios de mixage. Ces combinaisons sont présentées aux participants selon le même protocole qu'en Phase 1, afin de mesurer l'effet de la superposition sur la perception. Les résultats permettront d'établir le système de correspondance entre types de sons "négatifs" et types de sons "neutres" compensateurs.
