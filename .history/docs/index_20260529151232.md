...
Cette question soulève plusieurs enjeux. D'une part, nous n'avons pas trouvé après nos recherches une taxonomie perceptive des sons résidentiels urbains établie pour le contexte montréalais. D'autre part, les mécanismes par lesquels un son neutre modifie la perception d'un son négatif (qu'il s'agisse d'un simple camouflage ou d'une transformation plus profonde de l'expérience sonore ) restent peu explorés. Enfin, les solutions de requalification sonore existantes sont rarement conçues à partir de données perceptives recueillies directement auprès des populations concernées et impliquées.
