...
La <span style="color:#9E1946;
  ...
  font-weight: bold;">superposition </span> de sons naturels aux différents évènements sonores, dans le but d'obtenir des combinaisons acoustiques plus agréables, le but n'étant pas de supprimer les sons indésirables, mais de modifier leur perception en les combinant avec une source sonore plaisante.
