...
Ces expériences se sont toutes réalisées dans un même local, relativement isolé avec un décor qui rappelle le confort intérieur d'un logement. Le local était éclairé
