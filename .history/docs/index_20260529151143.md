...
Par ailleurs, les solutions existantes de traitement du bruit ( isolation acoustique, atténuation à la source ) sont souvent coûteuses, difficilement applicables en rénovation, et ne tiennent pas compte de la dimension perceptive <!--( cite la métaanalyse d) -->. Des approches alternatives, comme le masquage sonore offrent des perspectives prometteuses mais restent peu documentées.
