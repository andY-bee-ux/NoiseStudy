...
Ces expériences se sont toutes réalisées dans un même local, relativement isolé avec un décor qui rappelle le confort intérieur d'un logement. Le local était éclairé et bien aéré. Le casque utilisé est le ATH-M20x, reconnu pour sa grande isolation du bruit e
