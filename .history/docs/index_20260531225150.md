...
Des participants sont exposés individuellement, en conditions contrôlées, à un ensemble de sons isolés présentés dans un ordre aléatoire propre à chaque 
participant. Chaque extrait, d'une durée de 30 secondes, est proposé à deux 
...
d'exposition sur la perception. Une pause silencieuse de 3 à 5 secondes est 
ménagée entre chaque extrait pour limiter les effets de contraste. À l'issue 
de chaque écoute, le participant évalue le son à l'aide d'un questionnaire 
structuré autour des attributs perceptifs de l'ISO 12913-2. Les données 
collectées font ensuite l'objet d'une analyse statistique permettant d'établir 
la taxonomie des sons.
